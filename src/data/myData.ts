...
export const jobs: Job[] = [
  {
    ...
    details: [
      ...
      {
        title: 'Built human-in-the-loop ML data and demo systems',
        lines: [
      ...
      {
        title: 'Built Audience AI mobile audio product end to end',
        lines: [
      ...
      {
        title: 'Led Spray Integrity Program product engineering',
        lines: [
      ...
      {
        title: 'Delivered practical client tools and data automation',
        lines: [
      ...
      {
        title: 'Mentored interns, remote workers, and product contributors',
        lines: [
      ...
      {
        title: 'Managed parallel client, startup, and release deadlines',
        lines: [
      ...
      {
        title: 'Led stakeholder, investor, and product demo meetings',
        lines: [
      ...
      {
        title: 'Navigated difficult client and payment-boundary conversations',
        lines: [
  ...
  },
  {
    ...
    details: [
      ...
      {
        title: 'Led requirements, testing, and offshore handoff work',
        lines: [
...
export const videogame_projects: Project[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Air, Ground & Water Friction',
      'Terrain-Aware A* Pathfinding',
      'Fog of War & Full-Map Simulation',
      'LOD Rendering & Spatial Grids',
      'Steam / Commercial Release Prep',
    ],
    icon: null,
    ...
    hasSound: false,
    description:
      'A commercial-release-oriented desktop RTS written in C++ with a custom engine, lockstep deterministic simulation, cross-OS state hashing, force/mass/momentum physics, terrain-aware pathfinding, LOD rendering, spatial partitioning, factories, resources, fog of war, and large armies.',
  },
...
export const myDataShort = 'Fullstack Apps, ML, Industrial Systems, Games, and Simulation';
...
export const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        title: 'Deployment',
        details: ['AWS', 'EC2', 'S3', 'Docker', 'Git', 'GitLab', 'Github', 'Release Tagging', 'Reproducible Builds'],
      },
    ],
  },
  {
