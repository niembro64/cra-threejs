...
export const jobs: Job[] = [
  {
    ...
    details: [
      ...
      {
        title: 'Led engineering delivery, mentorship, and stakeholder communication',
        lines: [
...
export const triviaItems: TriviaItem[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'text',
        text: ', the national ultimate frisbee league of South Korea, from 2015 - 2016. He coordinated regional leaders, captains, venues, budgets, and roughly 35 teams, then mentored his successor. He is currently a coordinator for ',
      },
      {
        type: 'link',
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'text',
        text: ' concert violinist, piano composer, flamenco guitarist, and electronic music DJ. He has performed with orchestras, bands, and quartets; composed for television and games; and designed live-audio systems for Jackson and Mars.',
      },
    ],
  },
  {
