...
export const Footer: React.FC = () => {
  return (
    <footer className="py-12 px-6 bg-black border-t border-green-500/30 font-mono text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mb-6 text-sm">
              Digital streetwear for the cybernetic generation. Bridging the gap between fashion and technology.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white text-lg mb-4">Shop</h4>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">New Arrivals</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Bestsellers</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Collections</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Accessories</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Sale</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Press</a></li>
          ...
          {/* Help */}
          <div>
            <h4 className="text-white text-lg mb-4">Help</h4>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Customer Service</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Shipping Info</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Returns & Exchanges</a></li>
              <li><a href="#" className="hover:text-green-400 transition-colors duration-300">Size Guide</a></li>
