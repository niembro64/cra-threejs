...
export const ContactSection: React.FC = () => {
  ...
  const TerminalText = ({ text }: { text: string }) => {
    ...
    return (
      <div className="font-mono">
        ...
        {cursorVisible && <span className="text-green-400 animate-pulse">|</span>}
      </div>
    )
  }
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-24 px-6 bg-black text-green-400 opacity-0 translate-y-10 transition-all duration-1000"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto mb-16">
          <div className="bg-gray-900 border border-green-500/30 p-4 font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Contact form */}
          <div className="bg-gray-900 border border-green-500/30 p-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black border border-green-500/30 text-green-300 focus:border-green-400 focus:outline-none focus:ring-1 focus:ring-green-400"
                  required
              ...
              <div className="mb-6">
                <label htmlFor="subject" className="block mb-2 font-mono text-sm">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-green-400 text-black font-mono hover:bg-green-300 transition-colors duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed"
                disabled={status === "submitting"}
              >
                {status === "submitting" ? (
              ...
              {/* Status message */}
              <div className="h-6 mt-4 text-center font-mono">
                {status === "success" && (
          ...
          {/* Contact information */}
          <div className="bg-gray-900 border border-green-500/30 p-8">
            <h3 className="text-2xl font-bold mb-6 text-white">Connection Details</h3>
            
            <div className="space-y-8">
              <div>
                <div className="font-mono text-sm text-gray-400 mb-2">EMAIL</div>
                <a 
              ...
              <div>
                <div className="font-mono text-sm text-gray-400 mb-2">PRESS INQUIRIES</div>
                <a 
              ...
              <div>
                <div className="font-mono text-sm text-gray-400 mb-2">HEADQUARTERS</div>
              ...
              <div>
                <div className="font-mono text-sm text-gray-400 mb-2">SOCIAL</div>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 flex items-center justify-center border border-green-500/30 text-green-400 hover:bg-green-400 hover:text-black transition-colors duration-300">
            ...
            {/* FAQ teaser */}
            <div className="mt-12 p-6 bg-black border border-green-500/30">
              <h4 className="text-xl font-bold mb-4 text-white">Frequently Asked Questions</h4>
              <p className="text-green-300 mb-4">
                Need information about sizing, shipping, or returns? Check our comprehensive FAQ section.
              </p>
              <a 
                href="#" 
                className="inline-block px-6 py-2 border border-green-400 text-green-400 font-mono hover:bg-green-400/10 transition-colors duration-300"
              >
                VIEW_FAQ()
              </a>
            </div>
